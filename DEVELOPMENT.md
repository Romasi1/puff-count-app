...
```bash
git remote add encore encore://puff-count-app-tthi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/puff-count-app-tthi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/puff-count-app-tthi/settings/integrations/github)
